  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-orange-50 to-indigo-100 relative">
      ...
      <main className="container mx-auto mt-8 px-4 pb-24 relative z-10">
        ...
        <h2 className="text-3xl font-bold text-center mb-8 text-orange-700">Intercambia idiomas con hablantes nativos</h2>
        
        <div className="flex justify-center mb-12">
          <div className="relative w-full max-w-xl">
            <Input type="text" placeholder="Buscar idiomas o usuarios..." className="pl-10 pr-4 py-3 rounded-full bg-white/50 backdrop-blur-sm border-orange-200 focus:border-orange-400 focus:ring-orange-400" />
        ...
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-center mb-8 text-orange-700">Testimonios de usuarios</h3>
